...
import { View, Text, Image, ScrollView, FlatList, ActivityIndicator, StyleSheet, TouchableOpacity, Modal, Alert } from "react-native";
...
export default function ChildProfile() {
    ...
    const { appUser, setUser, setKindergardenId } = useAuth();
